...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/cp_ep.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code']    = 'cp_ep';

    $modules[$i]['version'] = '1.0.0';

    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'cp_ep_desc';
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_cp_ep.jpg';
...
class cp_ep
{
    ...
    function calculate($goods_weight, $goods_amount, $goods_number, $zip=null)
    {
        ...
        {
            $info = canadapost_get_shipping_info($goods_weight, $zip, "DOM.EP");
