...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/shun_lu.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_shun_lu.jpg';
